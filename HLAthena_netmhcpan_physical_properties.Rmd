...
temp <- merge(map8_peps, cmv_hlathena, by="Peptide")
temp$Source <- "cmv"
merged_peps_umap8 <- rbind(merged_peps_umap8, temp)
...
temp <- merge(map9_peps, cmv_hlathena, by="Peptide")
temp$Source <- "cmv"
merged_peps_umap9 <- rbind(merged_peps_umap9, temp)
...
temp <- merge(map10_peps, cmv_hlathena, by="Peptide")
temp$Source <- "cmv"
merged_peps_umap10 <- rbind(merged_peps_umap10, temp)
...
temp <- merge(map11_peps, cmv_hlathena, by="Peptide")
temp$Source <- "cmv"
merged_peps_umap11 <- rbind(merged_peps_umap11, temp)
